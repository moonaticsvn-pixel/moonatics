      ...
      <div className="page">
        ...
        {currentPage === "home" && <div className="hero">
          ...
          <div className="hero-logo">
            {data.logoUrl ? <img src={data.logoUrl} alt="Moonatics Logo" /> : <span style={{fontSize:64}}>{data.logoEmoji || "🌙"}</span>}
          </div>
        ...
        {currentPage === "home" && <div className="content">
          ...
          <div className="donate-cta-box">
            ...
            <div className="qr-wrap">
              {data.qrUrl
                ? <img src={data.qrUrl} alt="QR Donate" className="qr-img" style={{borderRadius:12}} />
                ...
                <tr key={i}>
                  <td>
                    {memberImages?.[g.name]?.[0]
                      ? <img src={memberImages[g.name][0]} alt={g.name} style={{width:36,height:36,borderRadius:8,objectFit:"cover",display:"block"}} />
        ...
        <div style={{display:"grid",gridTemplateColumns:"minmax(0,1fr) minmax(0,1.4fr)",gap:24}}>
          ...
          <div>
            <div style={{borderRadius:16,overflow:"hidden",aspectRatio:"1/1",background:"rgba(139,92,246,0.1)",border:"1px solid rgba(139,92,246,0.2)",marginBottom:16}}>
              {r.artwork
                ? <img src={r.artwork} alt={r.title} style={{width:"100%",height:"100%",objectFit:"cover"}} />
            ...
            <div style={{background:"rgba(255,255,255,0.03)",border:"1px solid rgba(139,92,246,0.2)",borderRadius:12,padding:16,display:"flex",flexDirection:"column",gap:10}}>
              ...
              {/* Streaming links */}
              {(r.spotifyLink || r.appleMusicLink || r.zingLink || r.otherLink) && (
                <div style={{display:"flex",flexWrap:"wrap",gap:6,paddingTop:4}}>
                  ...
                  {r.otherLink && <a href={r.otherLink} target="_blank" rel="noreferrer" style={{background:"rgba(139,92,246,0.3)",color:"#c4b5fd",padding:"5px 12px",borderRadius:20,fontSize:11,fontWeight:700,textDecoration:"none"}}>🔗 Khác</a>}
                </div>
              )}
            </div>
          </div>
      ...
      {releases.map((r, i) => (
        <div key={i} onClick={() => setDetail(i)} style={{background:"rgba(255,255,255,0.03)",border:"1px solid rgba(139,92,246,0.2)",borderRadius:14,overflow:"hidden",cursor:"pointer",transition:"transform .2s, box-shadow .2s"}}
          ...
          <div style={{aspectRatio:"1/1",background:"rgba(139,92,246,0.1)"}}>
            {r.artwork
              ? <img src={r.artwork} alt={r.title} style={{width:"100%",height:"100%",objectFit:"cover",display:"block"}} />
...
function OriginalCMSTab({ data, onSave }) {
  const blank = () => ({ title:"", date:"", artwork:"", composer:"", producer:"", vocal:"", lyrics:"", mvLink:"", spotifyLink:"", appleMusicLink:"", zingLink:"", otherLink:"", description:"" });
            ...
            {openIdx===i && (
              <div style={{marginTop:12,display:"flex",flexDirection:"column",gap:2}}>
                ...
                <div className="row2">
                  ...
                  <Field label="Link khác" value={r.otherLink} onChange={v=>update(i,"otherLink",v)} />
                </div>
